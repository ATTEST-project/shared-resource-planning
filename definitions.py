...
COST_CONSUMPTION_CURTAILMENT = 500.00
PENALTY_SLACK_VOLTAGE = 1e6
PENALTY_SLACK_BRANCH_FLOW = 1e6
PENALTY_GENERATION_CURTAILMENT = 1e6
PENALTY_LOAD_CURTAILMENT = 100e3
PENALTY_STORAGE_USAGE = 1e-2
...
GEN_CONTROLLABLE_TYPES = [GEN_REFERENCE, GEN_CONVENTIONAL_GENERAL, GEN_CONVENTIONAL_GAS, GEN_CONVENTIONAL_COAL, GEN_CONVENTIONAL_HYDRO]
GEN_CURTAILLABLE_TYPES = [GEN_NONCONVENTIONAL_SOLAR, GEN_NONCONVENTIONAL_WIND, GEN_NONCONVENTIONAL_HYDRO, GEN_INTERCONNECTION, GEN_NONCONVENTIONAL_OTHER]
GEN_MAX_POWER_FACTOR = 0.90
GEN_MIN_POWER_FACTOR = -0.90

ENERGY_STORAGE_MAX_POWER_CHARGING = 0.90
ENERGY_STORAGE_MAX_POWER_DISCHARGING = 0.90
...
TRANSFORMER_MAXIMUM_RATIO = 1.10
TRANSFORMER_MINIMUM_RATIO = 0.90
...
UNKNOWN_TRANSMISSION_VOLTAGE_LEVEL = 220.0
UNKNOWN_DISTRIBUTION_VOLTAGE_LEVEL = 30.0