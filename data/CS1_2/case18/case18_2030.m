...
mpc.branch = [
	...
	50	51	0.0005	0.00344	0	15	15	15	0	0	1	-360	360;
];

%% energy storage
%	Bus	S, [MW]	E, [MWh]	Einit, [MWh]	EffCh	EffDch	MaxPF	MinPF
mpc.energy_storage = [
	2	0.5	2.5	1.25	0.95	0.95	0.80	-0.80;
	8	0.5	2.5	1.25	0.95	0.95	0.80	-0.80;
	21	0.5	2.5	1.25	0.95	0.95	0.80	-0.80;
	23	0.5	2.5	1.25	0.95	0.95	0.80	-0.80;
];
